...
def entry(request, entry):
    ...
    if entryPage is None:
        return render(request, "encyclopedia/nonExistingEntry.html", {
            "entryTitle": entry,
            "error_link": "/",
            "massege1": "An unexpected error has occured. To view all entries ",
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if(util.get_entry(title) is None or form.cleaned_data["edit"] is True):
                ...
                "entry": title,
                "error_link": "/newEntry",
                "massege1": "This entry already already seems to exist. To view all entries, ",
                "massege2": "Alternately, you can try again by changing the entry name."
                })
        else:
